 ...
 * @version $Id: MarlinSteerCheck.h,v 1.14 2006-11-14 16:01:41 engels Exp $
 */
...
namespace marlin {
  ...
  public:
    ...
    /** Returns true if a Processor of the given type already exists */
    bool existsProcessor( const std::string& type );
