...
namespace marlin{
  ...
  void MarlinSteerCheck::saveAsXMLFile( const string& file ){
    ...
    outfile << "            - Processors that are not installed in your Marlin binary lost all their descriptions as well.\n";
    outfile << "            - All extra parameters that aren't categorized as default in a processor lost their descriptions.\n";
    outfile << "================================================================================================================\n";
    outfile << "-->\n";
